...
| [0009 — Azure SDK na borda Service Bus do dossiê](0009-azure-sdk-service-bus-dossie.md) | Aceito | Para permanecer no Quarkus 3.33 LTS e autenticar com Entra ID, a futura borda Service Bus do dossiê usará o Azure SDK Java com AMQP sobre WebSockets/TLS em TCP 443 e excluirá SmallRye AMQP; a decisão não implementa a borda nem elimina os gates técnicos. | Propor ou alterar Azure Service Bus, AMQP, Entra ID, cliente de mensageria, transporte, agendamento, settlement ou transação do dossiê. |
