...
8. As Fases 0 a 11 foram encerradas com GO humano. A Fase 12 limita-se a alinhar o package da
   borda REST de `dossieproduto`, sem alterar endpoint, contrato ou comportamento.
9. O package tecnico compartilhado de erro `arquitetura.excecao.dto` permanece como excecao
   arquitetural documentada; ele nao deve ser renomeado nesta fase.
10. Ao concluir a Fase 12, publique o checkpoint C12 e aguarde GO humano; nao inicie nova fase.
