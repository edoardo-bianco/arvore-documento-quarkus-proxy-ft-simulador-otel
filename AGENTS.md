...
3. Confirme que a branch atual corresponde a fase em execucao, no formato
   ...
   atual e `refactor/ddd-fase-8-baseline`.
...
7. A refatoracao de producao foi encerrada com GO humano no checkpoint C6. As Fases 7 e 8 sao
   exclusivamente documentais e nao autorizam endpoint, contrato ou alteracao de producao.
8. A Fase 8 foi encerrada com GO humano no C8. Qualquer novo trabalho exige novo plano, nova fase
