...
public class ChecklistMtrStubTestResource implements QuarkusTestResourceLifecycleManager {

    static final String CAMINHO_CHECKLIST =
    ...
    public Map<String, String> start() {
        try {
            ...
            throw new IllegalStateException("Nao foi possivel iniciar o stub MTR de checklist", e);
        }

        executor = Executors.newFixedThreadPool(4);
        server.setExecutor(executor);
        server.createContext("/oidc/token", this::handleToken);
        server.createContext(CAMINHO_CHECKLIST, this::handleChecklist);
        server.start();

        String baseUrl = "http://127.0.0.1:" + server.getAddress().getPort();
        return Map.of(
                "quarkus.rest-client.parametrizacao-checklist.url", baseUrl + "/simtr",
                "quarkus.rest-client.parametrizacao-checklist.read-timeout", "5000",
    ...
    private void handleChecklist(HttpExchange exchange) throws IOException {
