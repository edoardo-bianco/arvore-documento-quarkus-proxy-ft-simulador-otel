package br.gov.caixa.simtr.hub.arvoredocumento.dominio.erro;

import java.util.List;

public final class FalhaConsultaProcessoParametrizado extends RuntimeException {
    ...
    public FalhaConsultaProcessoParametrizado(
            Tipo tipo,
            Integer status,
            String recurso,
            String idErro,
    ...
    private static String mensagem(List<String> mensagens, Throwable causa) {
        ...
        return causa != null ? causa.getMessage() : "Falha ao consultar processo parametrizado";
    }
}
