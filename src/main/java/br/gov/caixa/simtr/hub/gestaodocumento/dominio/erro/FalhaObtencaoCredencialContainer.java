...
public final class FalhaObtencaoCredencialContainer extends RuntimeException {
    ...
    public FalhaObtencaoCredencialContainer(
            Tipo tipo,
            Integer status,
            String recurso,
            String idErro,
    ...
    private static String mensagem(List<String> mensagens, Throwable causa) {
        ...
        return causa != null ? causa.getMessage() : "Falha ao obter credencial de container";
    }
}
