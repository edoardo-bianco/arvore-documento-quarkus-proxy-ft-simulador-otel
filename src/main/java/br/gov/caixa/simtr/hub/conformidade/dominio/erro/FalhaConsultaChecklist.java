...
public final class FalhaConsultaChecklist extends RuntimeException {
    ...
    private static String mensagem(List<String> mensagens, Throwable causa) {
        ...
        return causa != null ? causa.getMessage() : "Falha ao consultar checklist";
    }
}
