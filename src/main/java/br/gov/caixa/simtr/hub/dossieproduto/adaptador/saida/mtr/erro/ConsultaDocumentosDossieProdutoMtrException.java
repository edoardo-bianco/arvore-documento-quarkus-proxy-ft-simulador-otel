...
public abstract class ConsultaDocumentosDossieProdutoMtrException extends RuntimeException {

    private static final String MENSAGEM_OBSERVAVEL = "Erro retornado pelo servico MTR";
    private final int status;
    private final Erro erro;

    protected ConsultaDocumentosDossieProdutoMtrException(int status, Erro erro) {
    ...
    public static final class Negocio extends ConsultaDocumentosDossieProdutoMtrException {
        public Negocio(int status, Erro erro) {
            super(status, erro);
        }
    }

    public static final class TecnicaCliente extends ConsultaDocumentosDossieProdutoMtrException {
        public TecnicaCliente(int status, Erro erro) {
            super(status, erro);
        }
    }

    public static final class Servidor extends ConsultaDocumentosDossieProdutoMtrException {
