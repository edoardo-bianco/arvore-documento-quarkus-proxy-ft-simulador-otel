...
public record ConsultaDocumentosDossieProdutoResponse(
        ...
        @JsonProperty("url") @JsonInclude(JsonInclude.Include.NON_NULL) String url,
        @JsonProperty("atributos") @JsonInclude(JsonInclude.Include.NON_NULL)
        List<Atributo> atributos,
        @JsonProperty("assinaturas_digitais") @JsonInclude(JsonInclude.Include.NON_NULL)
        List<AssinaturaDigital> assinaturasDigitais,
        @JsonProperty("conformidade") @JsonInclude(JsonInclude.Include.NON_NULL)
        List<Conformidade> conformidade,
        @JsonProperty("propriedades") @JsonInclude(JsonInclude.Include.NON_NULL)
        List<Propriedade> propriedades,
        @JsonProperty("outsourcing") @JsonInclude(JsonInclude.Include.NON_NULL)
        List<Outsourcing> outsourcing,
        @JsonProperty("armazenamento") @JsonInclude(JsonInclude.Include.NON_NULL)
    ...
    @SuppressWarnings("java:S107") // Os campos refletem o contrato publico v1 aprovado.
    public record Outsourcing(
            ...
            @JsonProperty("solicitacao_tratamento_imagem") Boolean solicitacaoTratamentoImagem,
            @JsonProperty("solicitacao_extracao") Boolean solicitacaoExtracao,
            @JsonProperty("solicitacao_validacao_negocial") Boolean solicitacaoValidacaoNegocial,
