...
public abstract class CriacaoDossieProdutoMtrException extends RuntimeException {

    private final int status;
    private final Erro erro;

    protected CriacaoDossieProdutoMtrException(int status, Erro erro) {
        super(mensagem(erro));
        this.status = status;
        this.erro = erro;
    }
    ...
    public static final class Negocio extends CriacaoDossieProdutoMtrException {
        public Negocio(int status, Erro erro) {
            super(status, erro);
        }
    }

    public static final class TecnicaCliente extends CriacaoDossieProdutoMtrException {
        public TecnicaCliente(int status, Erro erro) {
            super(status, erro);
        }
    }

    public static final class Servidor extends CriacaoDossieProdutoMtrException {
