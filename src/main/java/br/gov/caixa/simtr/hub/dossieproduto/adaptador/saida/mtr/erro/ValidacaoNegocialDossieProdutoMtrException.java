...
public abstract class ValidacaoNegocialDossieProdutoMtrException extends RuntimeException {

    private final int status;
    private final Erro erro;

    protected ValidacaoNegocialDossieProdutoMtrException(int status, Erro erro) {
        super(mensagem(erro));
        this.status = status;
        this.erro = erro;
    }
    ...
    public static final class Negocio extends ValidacaoNegocialDossieProdutoMtrException {
        public Negocio(int status, Erro erro) {
            super(status, erro);
        }
    }

    public static final class TecnicaCliente extends ValidacaoNegocialDossieProdutoMtrException {
        public TecnicaCliente(int status, Erro erro) {
            super(status, erro);
        }
    }

    public static final class Servidor extends ValidacaoNegocialDossieProdutoMtrException {
