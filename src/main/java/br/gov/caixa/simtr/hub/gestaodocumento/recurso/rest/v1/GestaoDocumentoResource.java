package br.gov.caixa.simtr.hub.gestaodocumento.recurso.rest.v1;
...
public class GestaoDocumentoResource {
    ...
    private final GestaoDocumentoFachada gestaoDocumentoFachada;
    private final GestaoDocumentoMapper gestaoDocumentoMapper;

    @Inject
    public GestaoDocumentoResource(GestaoDocumentoFachada gestaoDocumentoFachada,
                                   GestaoDocumentoMapper gestaoDocumentoMapper) {
        this.gestaoDocumentoFachada = gestaoDocumentoFachada;
    ...
    public Uni<Response> gerarCredencialContainer() {
        ...
        return gestaoDocumentoFachada.gerarCredencialContainer()
