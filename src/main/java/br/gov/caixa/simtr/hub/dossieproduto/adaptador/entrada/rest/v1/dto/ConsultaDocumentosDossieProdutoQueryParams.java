...
public class ConsultaDocumentosDossieProdutoQueryParams {
    ...
    public ConsultaDocumentosDossieProdutoQueryParams() {
    }

    @SuppressWarnings("java:S107") // Os campos refletem os doze filtros publicos aprovados.
    public ConsultaDocumentosDossieProdutoQueryParams(
            String cnpj,
            String cpf,
            Long fase,
