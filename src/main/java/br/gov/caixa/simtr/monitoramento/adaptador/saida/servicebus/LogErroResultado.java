...
import br.gov.caixa.simtr.monitoramento.adaptador.saida.servicebus.dto.ErroResultadoDto;
...
final class LogErroResultado {
    ...
    private static final String EVENTO = "monitoramento.servicebus.resultado.falhou";
    ...
    enum Tipo {
        ...
        SERIALIZACAO_FALHOU("Falha ao serializar a mensagem de resultado.", "Falha de serializacao.");
        ...
        String codigo() {
            return "MONITORAMENTO_RESULTADO_" + name();
        }
    }
