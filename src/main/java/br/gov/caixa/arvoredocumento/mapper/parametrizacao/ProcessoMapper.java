package br.gov.caixa.arvoredocumento.mapper.parametrizacao;

import br.gov.caixa.arvoredocumento.api.dto.parametrizacao.processo.*;
import br.gov.caixa.arvoredocumento.domain.parametrizacao.processo.*;
